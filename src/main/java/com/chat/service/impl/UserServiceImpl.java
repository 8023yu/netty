...
import com.chat.netty.UserChanelRel;
...
public class UserServiceImpl implements UserService {
    ...
    public String saveMsg(ChatMsg chatMsg) {
        com.chat.model.ChatMsg msgDB = new com.chat.model.ChatMsg();
    ...
    @Override
    public List<com.chat.model.ChatMsg> getUnReadMsgList(String acceptUserId) {
        List<com.chat.model.ChatMsg> result = chatMsgMapper.getUnReadMsgListByAcceptUid(acceptUserId);
        return result;
    }
